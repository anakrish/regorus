...
namespace Regorus
{
    ...
    public unsafe sealed class AliasRegistry : SafeHandleWrapper
    {
        ...
        /// <param name="apiVersion">API version string (e.g. "2023-01-01")</param>
        ...
        /// <returns>JSON string: { "resource": &lt;normalized&gt;, "parameters": &lt;params&gt; }</returns>
        public string? NormalizeAndWrap(string resourceJson, string apiVersion, string contextJson, string parametersJson)
        {
            return Utf8Marshaller.WithUtf8(resourceJson, resPtr =>
                Utf8Marshaller.WithUtf8(apiVersion, apiPtr =>
        ...
        /// <param name="apiVersion">API version string</param>
        /// <returns>Denormalized ARM JSON string</returns>
        public string? Denormalize(string normalizedJson, string apiVersion)
        {
