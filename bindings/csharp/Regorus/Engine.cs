...
namespace Regorus
{
    ...
    public unsafe sealed class Engine : SafeHandleWrapper
    {
        ...
        public void SetExplanationSettings(bool enabled, ExplanationValueMode valueMode = ExplanationValueMode.Redacted, ExplanationConditionMode conditionMode = ExplanationConditionMode.PrimaryOnly)
        {
            UseHandle(enginePtr =>
            {
                CheckAndDropResult(Regorus.Internal.API.regorus_engine_set_explanation_settings((Regorus.Internal.RegorusEngine*)enginePtr, enabled, (byte)valueMode, (byte)conditionMode));
            });
        }
