...
mod tests {
    ...
    mod azure_policy_json {
        ...
        use crate::alias_registry::{
            regorus_alias_registry_builder_build, regorus_alias_registry_builder_drop,
            regorus_alias_registry_builder_load_json, regorus_alias_registry_builder_new,
            regorus_alias_registry_drop,
        };
        use crate::rvm::{
