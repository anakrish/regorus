...
An interactive web-based playground for the Regorus Virtual Machine (RVM). This tool allows you to write Rego or Cedar policies, compile them to RVM assembly, and evaluate them with input data.
...
### 🚀 **Policy Development**
- **Monaco Editor Integration**: Full-featured code editor with Rego and Cedar syntax highlighting
- **Real-time Compilation**: Compile Rego or Cedar policies to RVM assembly with detailed error reporting
...
- **Language Switcher**: Toggle between Rego and Cedar modes
- **Comparative Examples**: Load the same scenario in multiple languages
- **Language-aware Inputs**: Cedar request + entities, or Rego input + data
...
- **Evaluation Settings**: Auto-evaluation
