...
pub fn ensure_set(fcn: &str, arg: &Expr, v: Value) -> Result<Rc<crate::collections::Set>> {
    Ok(match v {
        Value::Set(s) => s,
        _ => {
            let span = arg.span();
...
pub fn ensure_object(fcn: &str, arg: &Expr, v: Value) -> Result<Rc<crate::collections::Object>> {
    Ok(match v {
        Value::Object(o) => o,
        _ => {
            let span = arg.span();
