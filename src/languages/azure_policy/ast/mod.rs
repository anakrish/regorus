...
//!
//! Every AST node carries a [`Span`] pointing back into the original JSON source,
//! enabling precise error messages during compilation and validation.
//!
...
/// The 20 Azure Policy condition operators.
