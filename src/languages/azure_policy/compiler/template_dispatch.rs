...
//!
//! This module is separated from `expressions.rs` to keep file sizes
//! manageable.  It handles the `compile_call_expr` dispatch for
//! ARM template functions (string, collection, numeric, encoding).
...
impl Compiler {
    ...
    /// Compile arguments and emit a builtin call — convenience wrapper.
